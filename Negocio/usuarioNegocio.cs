...
namespace Negocio
{
    public class usuarioNegocio
    {
        ...
        public List<Entidad.Usuarios> obtenerListadoUsuariosNegocio()
        {

            Datos.usuarioDatos dc = new Datos.usuarioDatos();
            List<Entidad.Usuarios> listadoUsuarios = new List<Entidad.Usuarios>();

            try
            {

                listadoUsuarios = dc.obtenerListadoUsuariosDatos();
        ...
        } // fin del método obtenerListadoUsuarios
